...
from easm_pipeline.source_to_skills.script_mining.script_schema import ScriptValidationResult
...
class RegistryBuilder:
    ...
    def update(
        ...
        *,
        ...
        existing = SkillsRegistry(generated_at=datetime.now(timezone.utc).isoformat(), skills=())
        if not replace:
        ...
        logger.info(
            "Updated skills registry: path={} entries={} replace={}",
            registry_path,
            len(registry.skills),
            replace,
        )
