...
class SkillValidator:
    ...
    def _validate_instruction_text(self, value: object) -> list[str]:
        ...
        if "## Scripts" not in value:
            errors.append("instructions: must include ## Scripts")
        if "## Inputs" not in value:
            errors.append("instructions: must include ## Inputs")
        if "## Output" not in value:
            errors.append("instructions: must include ## Output")
