...
from easm_pipeline.extraction.common import slugify
from easm_pipeline.extraction.dependency_resolver import DependencyContext
...
def build_candidate_prompt(capability: CapabilitySlice, dependencies: DependencyContext) -> str:
    return (
        ...
        "Use skill_id format skill_<lower_snake_case_name> when extracting.\n\n"
...
def _fallback_extract_decision(
    ...
    return CandidateDecision(
        ...
        skill_id=f"skill_{slugify(node.name, max_length=48).replace('-', '_')}",
